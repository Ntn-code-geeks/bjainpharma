...
function logged_user_data($sess_id) {  // for user id
    $ci = &get_instance();
...
function logged_user_desig($desig_id) {  // for user designation
    $ci = &get_instance();
...
function logged_user_cities($cities_id) {  // for cities assign to the user
    $ci = &get_instance();
...
function logged_user_child($child_id) {  //child of the user
    $ci = &get_instance();
...
//            }
  ...
  function get_holiday_details($userId, $date){
    $ci = &get_instance();
    $col='holiday_id,user_ids,assign_by,remark,,status,from_date,to_date';
    $con='find_in_set('.logged_user_data($userId).',user_ids) and (from_date <="'.$date.'" and to_date>="'.$date.'")';
    $ci->db->select($col); 
