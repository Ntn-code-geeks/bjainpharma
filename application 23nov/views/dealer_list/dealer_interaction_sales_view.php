				...
				<div class="row">
					...
					<div class="form-group" >
						<table class="table table-bordered" style="background:#00c0ef">
							...
							<tr>
							<td>Sale</td>
							<?php if($order_amount->order_amount!=''){?>
							 <td id="sale<?=$val_d->d_id ?>" style="display: block"><input class="form-control"
																						   readonly
																						   id="sale_dealer<?=$val_d->d_id;?>" name="m_sale" value='<?=$order_amount->order_amount?>' type="text" ></td>
							<?php }else{?>
