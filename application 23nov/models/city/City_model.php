...
class City_model extends CI_Model {
	...
	public function get_city_list(){
        $col='city.city_id,city.city_name,state.state_name,state.state_id,city.is_metro,city.pool_pincode as pincode,city.status';
        $this->db->select($col); 
        $this->db->from('city'); 
    ...
    public function get_city_data($id){
        $col='city_id,city_name,is_metro,state_id,pool_pincode as pincode';
        $this->db->select($col); 
        $this->db->from('city'); 
