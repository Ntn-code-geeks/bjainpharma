...
class Data_report_Analysis extends CI_Model {


    /*
   * Developer: Nitin kumar
   * Email: 9993nitin@gmail.com
   * Dated: 08-07-2019
   *
   *  for the NoT MET highest and lowest report
   */
    public function not_met_analysis($data='',$spcode){
...
//               echo $this->db->last_query(); die;
    ...
    public function noorder_met_analysis($data='',$spcode){
...
//               echo $this->db->last_query(); die;
    ...
    public function productive_analysis($data='',$spcode){
...
//               echo $this->db->last_query(); die;
    ...
    public function secondary_analysis($data='',$spcode){
...
//               echo $this->db->last_query(); die;
    ...
    public function pharma_analysis($data='',$sp_code){
...
//                      echo $this->db->last_query(); die;
    ...
    public function dealer_analysis($data='',$sp_code){
...
//                      echo $this->db->last_query(); die;
    ...
    public function doc_analysis($data='',$sp_code){
...
//                      echo $this->db->last_query(); die;
    ...
    public function top_sales_cust($data='',$sp_code){
...
//          $doc_id=explode(',', $doc_are);
    ...
    public function top_payment_cust($data='',$sp_code){
...
//         echo $this->db->last_query(); die;
    ...
    public function top_secondary_cust($data='',$sp_code){
//all_user_sp_code();
...
//       pr($result); die;
    ...
    public function top_interaction_cust($data='',$sp_code){
...
//          pr($result_d); die;
    ...
    public function top_most_met_cust($data='',$sp_code){
...
//          pr($result_d); die;
    ...
    public function top_never_met_cust($data='',$sp_code){
        if($data!=''){
            $start = date('Y-m-d', strtotime($data));
        }
        else{
