...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "<MESSAGE> <AUTHKEY>104818AOPOZWRa59fab4ba</AUTHKEY> <SENDER>nbjain</SENDER> <ROUTE>Template</ROUTE> <CAMPAIGN>XML API</CAMPAIGN> <COUNTRY>country code</COUNTRY> <SMS TEXT=\"$message\" > <ADDRESS TO=\"$num1\"></ADDRESS> </SMS> <SMS TEXT=\"$message\" > <ADDRESS TO=\"$num2\"></ADDRESS> </SMS> </MESSAGE>",
