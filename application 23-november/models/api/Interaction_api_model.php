        ...
        // foreach ($data as $key => $value) {
             ...
             $asm_report_data = 
                array(
                    ...
                    'question_num'=>1,
                    'answer'=>$data->q1,
                    'interaction_date'=>strtotime($data->selectInteractionDate),
                    'interaction_city'=>$data->cityId,
                    'joint_work_with'=>$data->bossId,
...
/* End Dealer Inteaction Save */
    //https://console.cloud.google.com/apis/dashboard?project=bjainpharma&duration=PT1H
...
//          $url = "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=".$source."&destinations=".$destination.'&key=AIzaSyBW4XD3HI9gZfK-J36dRizXrw6ynJ_ztJI';
...
//          $url = "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=".$source."&destinations=".$destination.'&key=AIzaSyBW4XD3HI9gZfK-J36dRizXrw6ynJ_ztJI';
       ...
       // pr($response_a); die;
        ...
        {
            $dist_actual=explode(' ',$response_a->rows[0]->elements[0]->distance->text);
           
           if($dist_actual[1]==='m'){
               $distance = $dist_actual[0] * 0.001 ;
           }else{
               $distance=$dist_actual[0];
           }
