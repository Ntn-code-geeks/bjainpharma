  ...
  <link rel="stylesheet" href="<?php echo base_url();?>design/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
...
<!--  <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
   ...
   <!--     <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/1.10.19/js/jquery
...
<!-- AdminLTE Skins. Choose a skin from the css/skins
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>design/css/skins/_all-skins.min.css">
...
<!-- Bootstrap 3.3.7 -->
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>design/css/AdminLTE.css">

  <!-- iCheck -->

  <link rel="stylesheet" href="<?php echo base_url();?>design/plugins/iCheck/square/blue.css">
