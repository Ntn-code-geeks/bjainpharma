		   ...
		   ---------------------------- 
			...
			Tel: +91-120-49 33 333';
					...
					if (isset($interaction_data['m_sale']))//only product
					{
						...
						$sms = 'Thank You for your support to B.Jain Pharma. We are happy to receive your order. Order Details: ';
						...
						foreach ($orderDetails as $details) {
							...
							$orderData = $orderData . ' ' . get_product_name($details['product_id']) . '(' . get_packsize_name($details['product_id']) . ',quantity=' . $details['quantity'].'. ' ;
      ...
      //   <tbody>' . $emailordt . '</tbody><tfoot><tr><th colspan="4" style="text-align:right; border-right:none !important;">Total</th> <th colspan="4" style="text-align:right; border-left:none;">Rs.' . $total_cost . '</th><tr></tfoot></table> ';
				   ...
				   die;*/
					...
					redirect($_SERVER['HTTP_REFERER']);
						...
						if (!empty($interaction_data['m_sale']) || !empty($interaction_data['m_payment']) || !empty($interaction_data['m_stock']) || !empty($interaction_data['m_sample']) || (isset($interaction_data['meet_or_not']) || !empty($interaction_data['meet_or_not'])) || (!empty($interaction_data['telephonic']) ) ) {
									...
									try {
										...
										if (isset($interaction_data['meet_or_not'])) {
											if ($interaction_data['meet_or_not'] == 1) {
												...
												$sms = 'Thank You for your support to B.Jain Pharma. We want to provide you with the best experience possible! Any feedback/Query Call: 9899752292.';//but no sale or sample
...
//                    echo $sms; die;
												...
												$sms = 'I am visited your clinic today but was unable to meet you. May I request you to schedule time for a meeting, when I can meet you? Thank You!!!! Any feedback/Query Call: 9899752292.';
                      ...
                      <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
										...
										} else // for sale
										{
											if (isset($interaction_data['m_sale']) && isset($interaction_data['m_sample'])) {
												...
												$sms = 'Thank You for your support to B.Jain Pharma. We want to provide you with the best experience possible! To help us, please take a moment to leave your feedback. ';
												$sms1 = $sms;
												$sms = $sms . ' ' . $orderData;
												$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{
                     margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                  ...
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
												...
												$dealerSms = 'Dear Sir/Madam, we have received an order from Dr.' . $interaction_data['doc_name'] . '  Kindly deliver at mentioned time and discount.The order details are mentioned below. ' . $orderData.' Any feedback/Query Call: 9899752292.';

												$dealerSms1 = 'Dear Sir/Madam, we have received an order from Dr.' . $interaction_data['doc_name'] . '  Kindly deliver at mentioned time and discount.The order details are mentioned below. ';
                  ...
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
											...
											{
												$sms = 'Thank you Dear Doctor for your valuable time. Kindly give your feedback. Any feedback/Query Call: 9899752292.';
												$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{
                  margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                  <h3>Dear,</h3> <p>' . $sms . '</p><p><i>This is an auto generated email.</i></p>
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
											} else if (isset($interaction_data['m_sale']))//only product
											{
												$sms = 'Thank You for your support to B.Jain Pharma. We are happy to receive your order. Order Details:';
												$sms1 = $sms;
												$sms = $sms . ' ' . $orderData.' Any feedback/Query Call: 9899752292.';
												$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{
                     margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                  <h3>Dear,</h3> <p>' . $sms1 . '</p>' . $emailorderdata . '<p><i>This is an auto generated email.</i></p>
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
					   ...
					   Something went wrong.
									...
									try {
										...
										if (isset($interaction_data['meet_or_not'])) {
											if ($interaction_data['meet_or_not'] == 1) {
												# code...
												$sms = 'Thank you Dear Sub Dealer for your valuable time. We look forward to your kind support for B. Jain’s Product. Any feedback/Query Call: 9899752292.';//but no sale or sample
												$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{ margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                <h3>Dear,</h3> <p>' . $sms . '</p><p><i>This is an auto generated email.</i></p>
                <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
											} else {
												$sms = 'Sub Dealer I visited today but was unable to meet you. May I request you to suggest a suitable date and time for next meeting. Any feedback/Query Call: 9899752292.';
												$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{ margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                <h3>Dear,</h3> <p>' . $sms . '</p><p><i>This is an auto generated email.</i></p>
                <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
											}
                  ...
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
												...
												$dealerSms = 'Dear Dealer/Sub Dealer, We are happy to receive your order..  Kindly deliver at mentioned time and discount.The order details are mentioned below. ' . $orderData.' Any feedback/Query Call: 9899752292.';

												$dealerSms1 = 'Dear Dealer/Sub Dealer, We are happy to receive your order..  Kindly deliver at mentioned time and discount.The order details are mentioned below. ';
                  ...
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
					   ...
					   Something went wrong.
									...
									if (isset($interaction_data['meet_or_not'])) {
										if ($interaction_data['meet_or_not'] == 1) {
											# code...
											$sms = 'Thank you Dear Dealer for your valuable time. We look forward to your kind support for B. Jain’s Product. Any feedback/Query Call: 9899752292.';//but no sale or sample
											$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{ margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                <h3>Dear,</h3> <p>' . $sms . '</p><p><i>This is an auto generated email.</i></p>
                <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
										} else {
											$sms = 'Dealer I visited today but was unable to meet you.May I request you to schedule time for a meeting, when I can meet you? Any feedback/Query Call: 9899752292.';
											$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{ margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                <h3>Dear,</h3> <p>' . $sms . '</p><p><i>This is an auto generated email.</i></p>
                <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
										}
                  ...
                  <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
										...
										{
											$sms = 'Thank you Dear Dealer for your valuable time. Kindly give your feedback. Any feedback/Query Call: 9899752292.';
											$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{ margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
                <h3>Dear,</h3> <p>' . $sms . '</p><p><i>This is an auto generated email.</i></p>
                <div class="regards_box"><h3 class="user_name_regards">Regards,</h3><p class="user_name_brand">' . get_user_name(logged_user_data()) . '<br>BJain Pharmaceuticals Pvt. Ltd.</p></div></div></body></html>';
										} else if (isset($interaction_data['m_sale']))//only product
										{
											$sms = 'Thank you Dear Dealer for your support to B. Jain Pharma. We are happy to receive your order. Order Details:';
											$sms1 = $sms;
											$sms = $sms . ' ' . $orderData. 'Any feedback/Query Call: 9899752292.';
											$emailbody = '<html><head><title>BJain Pharmaceuticals</title><style type="text/css">body{padding:0;margin:0;font-family: calibri;}.content{ width:40%; margin:0 auto;}.regards_box{float:left;margin-top:20px;}p.user_name_brand{ margin:0px;}h3.user_name_regards{
                     margin:0px;padding-bottom:10px;}img.email_logo{ margin:15px 0px;}</style></head><body><div class="content"><center><img src="' . base_url() . '/design/bjain_pharma/bjain_logo.png" class="email_logo" style="width:250px;" /></center>  
