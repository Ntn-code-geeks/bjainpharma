              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                  <label>Headquarter Pincode *</label>
                    <input class="form-control" name="city_pin" placeholder="Enter Pincode ..." type="text" value="<?php if(isset($_POST['city_pin'])){echo $_POST['city_pin'];} elseif(isset($user_info) && $user_info[0]->hq_city_pincode!=0){echo $user_info[0]->hq_city_pincode;} ?>">               
