                            ...
                            if ($val['doi'] == $list) {
                                ...
                                if($source_city!=$val['source_city'] || $destination_city!=$val['destination_city'] || $interaction_date!=strtotime($val['doi'])){
                                    ...
                                    if($val['destination_city']!=$val['source_city'] || $val['is_stay'] || $ft==0 || $crdate!=$val['doi']) {
                                        ...
                                        /*
                                         * Nitin kumar
                                         * New DA concept As per Ranjan
                                         * Date: 15-Nov-2019
                                         * */
                                        $userDA=get_userwise_da($val['user_name']);
                                        /*Head Quarter */
                                        if(($destination_city == $source_city) || ($hqdistance < 15 )){
                                            $da=$userDA->hq;
                                        }else{
                                            /*Head Quarter */
                                            if(($destination_city != $source_city) && ($is_metro == 1)){
                                                $da=$userDA->hq;
                                            }else{
                                                /*Ex- Station*/
                                                if(($hqdistance < 75)&&($val['is_stay'] == 0)){
                                                    $da=$userDA->ex;
                                                }else{
                                                    /*Out Station*/
                                                    if($hqdistance > 75){
                                                        ...
                                                        /*Saturday && Stay*/
                                                        if(($hqdistance > 200) && ($val['is_stay']==1) && ($day == 'Sat')){
                                                            $da=$userDA->out_st;
                                                        }else{
                                                            /*Transit*/
                                                            if($hqdistance > 450){
                                        ...
                                        /*New Concept As per Ranjan Ends Here*/
    ...
    if(is_city_metro($cityID)==1){?>
        <tr>
            <td colspan="2">
                ...
                <input type="checkbox" name="metroAllow" id="metroAllow" style="height: 20px; width: 30px; position: relative; top: 4px;
"></td>
...
<td colspan="8" style="text-align: right;">
	<input readonly type="text" class="grandtot"
                                          value=""
                                          style="border: 0px;
font-weight: bold; text-align: right;"></td>
</tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-info pull-right">Final Submit</button>
                        <?php echo form_close();  ?>
