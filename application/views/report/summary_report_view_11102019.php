...
<style>
    @media  only screen and (max-width: 760px), (min-device-width: 768px) and (max-device-width: 1024px)  {
        ...
        */
        ...
        td:nth-of-type(3):before { content: "City Name"; }
        td:nth-of-type(4):before { content: "Designation"; }
        td:nth-of-type(5):before { content: "Total No. of Doctors"; }
        td:nth-of-type(6):before { content: "Total Secondary Sale"; }
        td:nth-of-type(7):before { content: "Total Productive Call"; }
        td:nth-of-type(8):before { content: "Total Number of Order"; }
        td:nth-of-type(9):before { content: "Total Not Met"; }
    }
...
<a href="<?=base_url() ?>interaction/summary_report"><button class="btn btn-danger"> Back</button></a>
                    </div>
                    <!-- /.box-body -->
