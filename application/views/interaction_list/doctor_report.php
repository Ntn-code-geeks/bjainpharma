				...
				<div class="row">
					...
					<div class="col-md-6" style="margin-top: 22px !important;">
						<div class="form-group" style="">
							...
							<select name="doc_user_id" id="working_user_id"  class="form-control select3" style="width:
						45%;">
								<option value="">--Select Dealers/Sub-Dealers--</option>
								<?php foreach($doctor_list as $k_cul=>$val_cul){
										echo $val_cul['doc_name']; ?>
										<option value="<?=$val_cul['doctor_id']?>" ><?=$val_cul['doc_name'];?></option>
									<?php	}	?>
							</select>
