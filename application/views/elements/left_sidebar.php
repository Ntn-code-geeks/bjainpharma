...
<!--          <span>Interaction Summary</span>-->
    ...
    <?php if(!is_admin()){ ?>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?= base_url();?>reports/reports/get_tada_report"><i class="fa fa-circle-o"></i>Genrate TA/DA Report</a></li>
        </ul>
      </li>
      <!-- End Reports Menu -->
     <?php } ?>
    ...
    ?> 
      <li>
        <a href="<?= base_url();?>reports/reports/user_ta_da_report">
        <i class="fa fa-line-chart"></i>
        <span>Users Ta/Da Reports</span>
        <span class="pull-right-container">
        </span>
        </a>
      </li>
      <?php }elseif(!is_admin()){  ?>
          <li>
        <a href="<?= base_url();?>reports/reports/my_ta_da_report">
        <i class="fa fa-line-chart"></i>
        <span>My Ta/Da Reports</span>
        <span class="pull-right-container">
        </span>
        </a>
      </li>
	...
	text-blue"></i><span>Users DA</span></a></li>
      ...
      <li><a href="<?= base_url();?>city/city"><i class="fa fa-circle-o text-pink"></i><span>Upload City</span></a></li>  
      <li><a href="<?= base_url();?>city/city/city_list"><i class="fa fa-circle-o text-gray"></i><span>City List</span></a></li>     
      <li><a href="<?= base_url();?>doctors/doctor/import_doctor"><i class="fa fa-circle-o text-blue"></i><span>Upload Doctor</span></a></li>
      <!--<li><a href="<?= base_url();?>pharmacy/pharmacy/import_pharmacy"><i class="fa fa-circle-o text-gray"></i><span>Import Sub Dealer</span></a></li>-->
      
      <li><a href="<?= base_url();?>reports/reports/ta_da_aprroved_report"><i class="fa fa-circle-o text-green"></i><span>TA DA Report</span></a></li>
      ...
      <li><a href="<?= base_url();?>admin_control/report/get_tada_report"><i class="fa fa-circle-o text-green"></i><span>Get TA DA Report Excel</span></a></li>
