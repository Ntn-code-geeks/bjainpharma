        ...
        <div class="row">
                ...
                <select name="state" id="state"  class="form-control select3" style="width: 100%;">
                  <option value="">--Select State--</option>
                    <?php foreach($state_data as $k_st => $val_st){ ?>   
                       <option value="<?=$val_st->state_id?>"><?=$val_st->state_name; ?></option>
                   <?php } ?>
                </select>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" name="city_name" placeholder="Enter Name ..." type="text" value="">               
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" name="pincode" placeholder="Enter Pincode of the City ..." type="text" value="">               
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input name="metro" checked type="radio" value="0">&nbsp;&nbsp;No    &nbsp;&nbsp;&nbsp;&nbsp;            
              <input name="metro" type="radio" value="1">&nbsp;&nbsp;Yes         
            </div>
          </div>
        </div>
        <div class="col-md-12">
