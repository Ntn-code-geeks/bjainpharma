 ...
 * Dated: 15-JAN-2019
 * 
 * For TP change permission to BOSS
 * * */
function send_email_boss($recipient, $senderemail='', $message){
...
function email_setting(){
   ...
   //      'smtp_user'=>'website@bjain.com',
   //      'smtp_pass'=>'afroj@123', //'bjainindia1', 
   //      'charset'=>'utf-8',
